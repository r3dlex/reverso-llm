    ...
    async def app(scope, receive, send):
        ...
        await send({
            ...
            "body": json.dumps({
                "output": [{
                    "type": "message",
                    "content": [{"type": "output_text", "text": "<think>secret</think>OK"}],
                }],
            }).encode("utf-8"),
            "more_body": False,
        })
        ...
        await send({
            ...
            "body": json.dumps({
                "output": [{
                    "type": "message",
                    "content": [
                        {"type": "output_text", "text": "The user asked for a short greeting."},
...
def test_drops_reasoning_summary_sse_events_and_repairs_content_part_done() -> None:
    ...
    assert payloads[-1]["part"] == {"type": "output_text", "text": "OK", "annotations": []}
